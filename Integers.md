...
1 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | 0 |  carry bits
  ...
  +---+---+---+---+---+---+---+---+
```
Since the carry bit generated by the addition of the most-significant bits with index `7` that indicates an *overflow* is discarded, a modulo `2^N` operation takes place so that `z = 256 mod 250 = 0` results.
